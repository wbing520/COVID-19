...
<img src="http://hsbadr.github.io/files/COVID-19_ID.svg" title="Geospatial ID for the Unified COVID-19 Dataset" alt="COVID-19 ID" style="display: block; margin: auto;" />
...
| **HydrometSource** | Character  |          | Source of hydromet data: [ERA5](https://www.ecmwf.int/en/forecasts/datasets/reanalysis-datasets/era5), [NLDAS](https://ldas.gsfc.nasa.gov/nldas) |
...
| **PolicySource**   | Character  | Source of policy data: [OxCGRT](https://github.com/OxCGRT) |
